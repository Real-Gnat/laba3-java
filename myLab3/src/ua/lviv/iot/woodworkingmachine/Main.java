...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        WoodworkingMachine cleaner = new WoodworkingMachine ("cleaner", "drawing", 30, ClassificationType.GORIZONTAL_DRILLING);
        WoodworkingMachine washer = new WoodworkingMachine ("washer","painter",  34);
